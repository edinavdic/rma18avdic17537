...
public class DohvatiKnjige extends AsyncTask<String, Integer, Void> {
    ...
    private IDohvatiKnjigeDone interfejs;
    private ArrayList<Knjiga> petpopetKnjiga;


    public DohvatiKnjige(IDohvatiKnjigeDone itf){
    ...
    protected Void doInBackground(String... params) {
        ...
        for(int k = 0; k < params.length; k++){
            ...
            String apiAdresa = "https://www.googleapis.com/books/v1/volumes?q=intitle:" + query + "&maxResults=5";
            try{
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        interfejs.onDohvatiDone(petpopetKnjiga);
    }
}
